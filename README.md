...
데모 데이터 기반 골드셋(25케이스) 측정 결과. 모델: `qwen2.5:3b` + `bge-m3`
...
> 상세 결과: `backend/tests/results/`  
> 개선 이력: `backend/tests/version.md`  
> 알려진 한계: vector 성능 낮음 (소형 모델), 크로스 도큐먼트 합산 미지원
