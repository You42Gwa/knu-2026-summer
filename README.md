...
```
질문 예시:
  "2024 하반기 동문장학금 1학년 대상자 명단을 알려줘"
  "친환경자동차과 1학년 장학생이 몇 명이야?"
  "신입생 동문회 장학금 지급 금액은 얼마야?"
  "관악부 학년별 명단 문서의 목적이나 내용을 설명해줘"
```
...
```json
{
  ...
  "source": "pandas",
  "sources": ["1. 2024학년도 신입생 동문회 장학금 지급 대상자(본교 상반기)-760만원.pdf"]
}
```
